...
import com.example.common.net.http.body.UploadProgressRequestBody;
...
import com.example.common.net.http.mode.MediaTypes;
...
//        builder.setType(MediaTypes.MULTIPART_FORM);
...
//        }
//        return apiService.uploadFiles(suffixUrl, builder.build()).compose(this.<T>norTransformer(type));
