package com.example.nichcomponent;
...
import com.example.nichcomponent.scaner.decoding.InactivityTimer;
import com.example.nichcomponent.tool.RxQrBarTool;
...
public class ActivityScanerCode extends BaseActivity {
    ...
    private  OnRxScanerListener mScanerListener=new OnRxScanerListener() {
        ...
        public void onSuccess(String type, Result result) {
            ...
            if (codeType.equals(BarcodeFormat.QR_CODE)){
                //二维码
                intent.putExtra("codeType",CommonComponent.SCAN_TYPE_QR);
            }else if (codeType.equals(BarcodeFormat.EAN_13)){
                //条形码
                intent.putExtra("codeType",CommonComponent.SCAN_TYPE_EAN_13);
            }else {
                //其它码
                intent.putExtra("codeType",CommonComponent.SCAN_TYPE_OTHER);
            }
        ...
        public void onFail(String type, String message) {
            getIntent().putExtra("isSuccess",false);
    ...
    public void handleDecode(Result result) {
        ...
        ViseLog.v("二维码/条形码 扫描结果", result1);
        if (mScanerListener == null) {
