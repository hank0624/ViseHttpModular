...
//
//import com.sjavamall.nich.R;
//import com.sjavamall.nich.utils.DisplayUtil;
...
//
    ...
    /**
     * banner圆角框架， 修改FrameLayout的圆角化（可设置一个方法，当为true时进行圆角代码）
     * @param canvas
     */
    @Override
    protected void dispatchDraw(Canvas canvas) {
        Path path = new Path();
//        path.addRoundRect(new RectF(0, 0, getMeasuredWidth(), getMeasuredHeight()), DisplayUtil.dp2Px(getContext(),8),DisplayUtil.dp2Px(getContext(),8), Path.Direction.CW);
