package com.example.common.net.common;
...
public class ViseConfig {
    ...
    public static final int DEFAULT_TIMEOUT = 15;//默认超时时间（秒）
    ...
    public static final long CACHE_MAX_SIZE = 20 * 1024 * 1024;//默认最大缓存大小（字节）
