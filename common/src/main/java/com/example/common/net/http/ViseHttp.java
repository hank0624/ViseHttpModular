package com.example.common.net.http;

import android.content.Context;

import com.example.common.net.http.callback.UCallback;
import com.example.common.net.http.config.HttpGlobalConfig;
import com.example.common.net.http.core.ApiCache;
import com.example.common.net.http.core.ApiManager;
import com.example.common.net.http.request.BaseHttpRequest;
import com.example.common.net.http.request.DeleteRequest;
import com.example.common.net.http.request.DownloadRequest;
import com.example.common.net.http.request.GetRequest;
import com.example.common.net.http.request.HeadRequest;
import com.example.common.net.http.request.OptionsRequest;
import com.example.common.net.http.request.PatchRequest;
import com.example.common.net.http.request.PostRequest;
import com.example.common.net.http.request.PutRequest;
import com.example.common.net.http.request.RetrofitRequest;
import com.example.common.net.http.request.UploadRequest;
